      ...
      FirebaseFirestore.instance
        ...
        for (var element in value.docs) {
          ...
          Localizations.localeOf(context).toString() == "en"
              ? gradess.add(element.data()['nameEN'] ?? "")
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropDown(
                              ...
                              Selecteditems: Localizations.localeOf(context)
                                          .toString() ==
                                      "en"
                                  ? Genders.map(buildMenuitem).toList()
                                  : arabicGenders.map(buildMenuitem).toList(),
                              ...
                              onChanged: (value) {
                                ...
                                for (var element in majors) {
                                  if (element.countryID ==
                                      countries[countriess.indexWhere(
                                              (f) => f == countryValue)]
                                          .idToEdit) {
                                    tmp.add(Localizations.localeOf(context)
                                                .toString() ==
                                            "en"
                                        ? element.nameEN
                                        : element.nameAr);
                                          ...
                                          await FirebaseAuth.instance
                                            ...
                                            FirebaseFirestore.instance
                                              ...
                                              'gender': GenderValue == "Male" ||
                                                      GenderValue == "ذكر"
                                                  ? 1
                                                  : 2, //Genders.indexWhere((f) => f == GenderValue),
                                              'dateOfBirth': selectedDate,
                                              'countryID': countries[countriess
                                                      .indexWhere((f) =>
                                                          f == countryValue)]
                                                  .idToEdit,
                                              'majorID': majors[majors.indexWhere((f) =>
                                                      ...
                                                      EduValue)]
                                                  .idToEdit,
                                              'gradeID': grades[grades.indexWhere((f) =>
                                                      (Localizations.localeOf(
                                                                      context)
                                                                  .toString() ==
                                                              "en"
                                          ...
                                          if (e.code == 'weak-password') {
                                            ...
                                            showDialog(
                                                ...
                                                builder: (context) {
                                                  return textAlert(
                                                      context,
                                                      LocaleKeys.weak_pass1
                                                          .tr(),
                                                      LocaleKeys.weak_pass2
                                                          .tr());
                                                });
                                          } else if (e.code ==
                                            ...
                                            showDialog(
                                                ...
                                                builder: (context) {
                                                  return textAlert(
                                                      context,
                                                      LocaleKeys.email_used1
                                                          .tr(),
                                                      LocaleKeys.email_used2
                                                          .tr());
                                                });
                                          } else if (e.code ==
                                              'invalid-email') {
                                            ...
                                            showDialog(
                                                ...
                                                builder: (context) {
                                                  return textAlert(
                                                      context,
                                                      LocaleKeys.inv_email1
                                                          .tr(),
                                                      LocaleKeys.inv_email2
                                                          .tr());
                                                });
                                          } else if (e.code ==
                                            ...
                                            showDialog(
                                                ...
                                                builder: (context) {
                                                  return textAlert(
                                                      context,
                                                      LocaleKeys.signup_error1
                                                          .tr(),
                                                      LocaleKeys.signup_error2
                                                          .tr());
                                                });
                                          }
                                        } catch (e) {
