...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void getSubjects() async{
    ...
    if(await checkConnectionn()){
      ...
      FirebaseFirestore.instance.collection('subjects').where("gradeID", isEqualTo: gradeID).get(const GetOptions(source: Source.server))
          .then((value) {
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return categoryCard(
                                ...
                                title: Localizations.localeOf(context).toString() == "en" ? subjects[index].nameEN : subjects[index].nameAr,
                                context: context,
                                onTap: (){

                                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Chapter(subjectID: subjects[index].idToEdit, name: Localizations.localeOf(context).toString() == "en" ? subjects[index].nameEN : subjects[index].nameAr,)));
                        ...
                        scoreStack(
                            ...
                            direction: Localizations.localeOf(context).toString() == "en" ? Direction.rtl : Direction.ltr,
